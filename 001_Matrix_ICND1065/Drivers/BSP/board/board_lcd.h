...
/**
  * @brief the address of write data & command (xmc_a20)
  */
#define XMC_LCD_COMMAND                  (0x60000000)
#define XMC_LCD_DATA                     (0x60000000 | 0x200000)
...
#define LCD_A20_GPIO_PORT                 GPIOE
#define LCD_A20_GPIO_CLK                  CRM_GPIOE_PERIPH_CLOCK
#define LCD_A20_GPIO_PIN                  GPIO_PINS_4
#define LCD_A20_GPIO_PINS_SOURCE          GPIO_PINS_SOURCE4
#define LCD_A20_GPIO_MUX                  GPIO_MUX_12

#define LCD_BL_GPIO_PORT									GPIOB
#define LCD_BL_GPIO_CLK									 	CRM_GPIOB_PERIPH_CLOCK	
#define LCD_BL_GPIO_PIN										GPIO_PINS_12
#define LCD_BL_GPIO_PINS_SOURCE          	GPIO_PINS_SOURCE12
#define LCD_BL_GPIO_MUX                  	GPIO_MUX_14
#define LCD_BL_TMR_CLK									 	CRM_TMR5_PERIPH_CLOCK	
#define LCD_BL_TMR                  			TMR5
#define LCD_BL_TMR_CH											CH1

#define LCD_RESET_GPIO_PORT								GPIOD
#define LCD_RESET_GPIO_CLK								CRM_GPIOD_PERIPH_CLOCK	
#define LCD_RESET_GPIO_PIN								GPIO_PINS_6

#define LCD_ON_GPIO_PORT									GPIOA
#define LCD_ON_GPIO_CLK										CRM_GPIOA_PERIPH_CLOCK	
#define LCD_ON_GPIO_PIN										GPIO_PINS_15


/* the lcd back light line */
#define LCD_BL_HIGH()											LCD_BL_GPIO_PORT->scr = LCD_BL_GPIO_PIN;
#define LCD_BL_LOW()                      LCD_BL_GPIO_PORT->clr = LCD_BL_GPIO_PIN;

/* the lcd reset line */
#define LCD_RESET_HIGH()									LCD_RESET_GPIO_PORT->scr = LCD_RESET_GPIO_PIN;
#define LCD_RESET_LOW()                   LCD_RESET_GPIO_PORT->clr = LCD_RESET_GPIO_PIN;

/* the lcd on line */
#define LCD_ON_HIGH()											LCD_ON_GPIO_PORT->scr = LCD_ON_GPIO_PIN;
#define LCD_ON_LOW()                   		LCD_ON_GPIO_PORT->clr = LCD_ON_GPIO_PIN;


#define SOFT_RESET												0x01
#define GET_PWR_MODE											0x0A
#define SET_PLL														0xE0
