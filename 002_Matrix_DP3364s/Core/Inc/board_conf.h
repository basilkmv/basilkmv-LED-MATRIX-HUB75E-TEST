...
// MATRIX PORT - CONFIGURE PINS
//Генератор DCLK
#define DCLK_TMR_CLK									 			CRM_TMR2_PERIPH_CLOCK	
#define DCLK_TMR                  					TMR2

//генератор линий
#define LINE_TMR_CLK									 			CRM_TMR5_PERIPH_CLOCK	
#define LINE_TMR                  					TMR5
#define LINE_INTERNAL_TRIGER_INPUT          TMR_SUB_INPUT_SEL_IS0
#define LINE_IRQHandler										  TMR5_GLOBAL_IRQHandler
#define LINE_IRQn													  TMR5_GLOBAL_IRQn

//ROW
#define ROW_TMR_CLK									 			  CRM_TMR3_PERIPH_CLOCK	
#define ROW_TMR                  					  TMR3
#define ROW_INTERNAL_TRIGER_INPUT_1         TMR_SUB_INPUT_SEL_IS1
//#define ROW_INTERNAL_TRIGER_INPUT_2         TMR_SUB_INPUT_SEL_IS2
#define ROW_INTERNAL_TRIGER_INPUT_3         TMR_SUB_INPUT_SEL_IS2
